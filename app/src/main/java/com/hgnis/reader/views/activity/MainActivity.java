...
import com.hgnis.reader.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initilizeALL() {
        ...
        bind.start.setOnClickListener(this);
        bind.downloadLanguages.setOnClickListener(this);
        bind.setLanguages.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.downloadLanguages:
                installVoiceData();
                break;
            case R.id.start:
                if (appSharePreference.getLanguageCode().isEmpty()) {
                    Toasty.error(this, getString(R.string.selectlanguagefirst)).show();
                } else {
                    showFloatingView(MainActivity.this, true, false);
                }
                break;
            ...
            case R.id.setLanguage:
                ...
                searchableSpinner.setTitle("Select language For Reader to read");
                ...
                setLanguage.setOnClickListener(view1 -> {
                    if (targetLanguage.isEmpty() && languageSelected.isEmpty()) {
                        Toasty.error(this, "Select a language");
                    } else {
                        appSharePreference.setLanguage(languageSelected);
                        appSharePreference.setLanguageCode(targetLanguage);
                        alertDialog.dismiss();
                        showFloatingView(MainActivity.this, true, false);
                    }
