package com.hgnis.reader.crop_slider;
...
import com.hgnis.reader.crop_slider.cropwindow.edge.Edge;
import com.hgnis.reader.crop_slider.cropwindow.handle.Handle;
import com.hgnis.reader.crop_slider.util.AspectRatioUtil;
import com.hgnis.reader.crop_slider.util.HandleUtil;
import com.hgnis.reader.crop_slider.util.PaintUtil;
...
public class CropImageView extends ImageView {
    ...
    private RectF getBitmapRect() {
        ...
        /*final float scaleX = matrixValues[Matrix.];
        final float scaleY = matrixValues[Matrix.MSCALE_Y];*/
        /*final float transX = matrixValues[Matrix.MTRANS_X];
        final float transY = matrixValues[Matrix.MTRANS_Y];*/
        ...
        final int drawableDisplayWidth = Math.round(drawableIntrinsicWidth);
        final int drawableDisplayHeight = Math.round(drawableIntrinsicHeight);

        // Get the Rect of the displayed image within the ImageView.
        final float left = Math.max(0, 0);
        final float top = Math.max(0, 0);
